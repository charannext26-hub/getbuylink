...
export default function SignupPage() {
  ...
  // 👇 NAYA STATE: Form ko hide/show karne ke liye
  ...
  return (
    // 👇 NAYA MOBILE FIX: min-h-[100dvh] aur py-10 use kiya taaki choti screen par scroll karte waqt layout fix rahe
        ...
        {successMsg ? (
          ...
          <>
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-100 rounded-xl px-6 py-3.5 text-slate-700 font-bold text-sm hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm mb-4"
            >
            ...
            {/* 👇 NAYA LOGIC: Form Hide/Show karne ke liye */}
            {!showEmailForm ? (
              <button 
                type="button"
                onClick={() => setShowEmailForm(true)}
                className="w-full flex items-center justify-center gap-2 bg-slate-50 border border-slate-200 rounded-xl px-6 py-3.5 text-slate-600 font-bold text-sm hover:bg-slate-100 hover:text-slate-800 transition-all"
              >
